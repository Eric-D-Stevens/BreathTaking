...
<body class="c22">
    <h1>Breath Taking</span></h1>
    <h3>An attempt to bootstrap a single speaker
    ...
    <p class="c4"><span class="c2">The raw audio data is 100 ms sampled at 16 KHz. This means that there are a total of
            ...
            style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 337.50px; height: 730.06px;"><img
                alt="" src="images/image12.png"
                style="width: 337.50px; height: 730.06px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);"
                title=""></span></p>
    <p class="c3"><span class="c2"></span></p>
