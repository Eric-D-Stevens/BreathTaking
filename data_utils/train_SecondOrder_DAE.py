...
from auto_encoder.models import AutoEncoder, SecondOrderAutoEncoder
...
def train(prior_model, sample_seconds, num_samples):
    ...
    AE = SecondOrderAutoEncoder(prior_model, d_in, relu1=140,
    ...
    torch.save(AE, os.path.join(utils.root, 'trained_modles', 's100k_t100ms_b300_e1000.model'))
    return AE


prior_model = torch.load(os.path.join(utils.root, 'trained_modles', 's100k_t10ms_b300_e1000.model'))
train(prior_model, 0.1, 10000)
